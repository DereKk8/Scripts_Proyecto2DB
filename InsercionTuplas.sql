...
VALUES ('00001', TO_DATE('2024-04-15', 'YYYY-MM-DD'), TO_DATE('2024-04-20', 'YYYY-MM-DD'), 'Pendiente', 500.00, 100.00, NULL, NULL, 1, '00001');
INSERT INTO RECLAMO (CODIGO, FECHA_DE_EMISION, FECHA_DE_SOLICITUD, ESTADO, MONTO_RECLAMADO, MONTO_DEBITADO, CODIGO_RAZON_PAGO_PARCIAL, FECHA_PAGO_PARCIAL, CITA_ID, POLIZA_NUMERO)
VALUES ('00001', TO_DATE('2024-04-15', 'YYYY-MM-DD'), TO_DATE('2024-04-20', 'YYYY-MM-DD'), 'Pendiente', 500.00, 20.00, NULL, NULL, 2, '00001');
INSERT INTO RECLAMO (CODIGO, FECHA_DE_EMISION, FECHA_DE_SOLICITUD, ESTADO, MONTO_RECLAMADO, MONTO_DEBITADO, CODIGO_RAZON_PAGO_PARCIAL, FECHA_PAGO_PARCIAL, CITA_ID, POLIZA_NUMERO)
VALUES ('00001', TO_DATE('2024-04-15', 'YYYY-MM-DD'), TO_DATE('2024-04-20', 'YYYY-MM-DD'), 'Pendiente', 500.00, 50.00, NULL, NULL, 3, '00001');
INSERT INTO RECLAMO (CODIGO, FECHA_DE_EMISION, FECHA_DE_SOLICITUD, ESTADO, MONTO_RECLAMADO, MONTO_DEBITADO, CODIGO_RAZON_PAGO_PARCIAL, FECHA_PAGO_PARCIAL, CITA_ID, POLIZA_NUMERO)
VALUES ('00001', TO_DATE('2024-04-15', 'YYYY-MM-DD'), TO_DATE('2024-04-20', 'YYYY-MM-DD'), 'Pendiente', 500.00, 500.00, NULL, NULL, 4, '00001');

...
VALUES (1, TO_DATE('2024-05-01', 'YYYY-MM-DD'), TO_TIMESTAMP('10:00:00', 'HH24:MI:SS'), NULL, NULL, 'Consulta de rutina', '1234567890', '2345678901');
...
VALUES ('1234567890', 'Ana Martínez', 'F', TO_DATE('1990-05-15', 'YYYY-MM-DD'), 'Calle Principal 123', '987654321');
...
VALUES ('00001', TO_DATE('2024-04-15', 'YYYY-MM-DD'), TO_DATE('2024-04-20', 'YYYY-MM-DD'), 'Pendiente', 500.00, 0.00, NULL, NULL, 1, '000001');
